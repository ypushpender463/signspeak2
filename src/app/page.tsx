...
import { ArrowRight, Mic, Video, Lock } from 'lucide-react';
...
export default function Home() {
  ...
  return (
    <div className="flex flex-col">
      ...
      {!user && (
         <section id="translate-locked" className="w-full py-12 md:py-24 lg:py-32 bg-secondary">
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                <Lock className="h-12 w-12 mx-auto text-primary" />
                <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl">Translation Features Locked</h2>
                <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  Please log in or create an account to access our real-time translation tools.
                </p>
